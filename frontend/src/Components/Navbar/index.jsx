...
import LogoImage from "../../assets/Fithub_logo.png";
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            {user.loginStatus && (
              <>
                <div className="d-flex">
                  <Link className="nav-link me-2 text-dark" to="/statuspage">
                    Status Updates
                  </Link>
                  <Link className="nav-link me-2 text-dark" to="/workoutplan">
                    Workout Plan
                  </Link>
                  <Link className="nav-link me-2 text-dark" to="/mealplan">
                    Meal Plan
                  </Link>
